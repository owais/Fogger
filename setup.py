...
DistUtilsExtra.auto.setup(
    name='fogger',
    version='0.1.7.2-appshowdown',
    license='GPL-3',
    author='Owais Lone',
    author_email='hello@owaislone.org',
    description='Fogger lets you create sandboxed web apps that behave like '\
            'regular desktop applications.',
    long_description='Fogger acts as a bridge between webapps and the linux desktop. It exposes an easy to use JS API to webapps which can be used to interact with the host desktop environment.',
